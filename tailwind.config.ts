  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 20px rgba(132, 39, 190, 0.3)' },
          '100%': { boxShadow: '0 0 30px rgba(200, 63, 223, 0.5)' },
        },
        gradientX: {
          '0%, 100%': {
